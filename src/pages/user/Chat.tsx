...
export default function Chat() {
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-4rem)]">
      <div className="p-4 border-b border-gray-700 bg-[#16162a] flex justify-between items-center">
        <h2 className="font-medium text-white">Chat com Administrador</h2>
            ...
            >
              <div
                className={`max-w-[70%] rounded-lg px-4 py-2 ${
                  message.isAdmin
                    ? 'bg-[#16162a] text-white border border-gray-700'
      ...
      <form onSubmit={sendMessage} className="p-4 bg-[#16162a] border-t border-gray-700">
        <div className="flex gap-2">
          <input
            ...
            className="flex-1 bg-[#1a1a2e] text-white border border-gray-700 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-[#2563eb] focus:border-transparent placeholder-gray-400"
          />
          <button
            type="submit"
            disabled={sendingMessage}
            className="bg-[#2563eb] text-white px-4 py-2 rounded-lg hover:bg-[#2563eb]/90 focus:outline-none focus:ring-2 focus:ring-[#2563eb] flex items-center gap-2 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {sendingMessage ? (
